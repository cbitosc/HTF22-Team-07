...
def send_email(request):
    send_mass_mail("Reminder to submit the assignment","The deadline is approaching , please do submit your aassignment",mail_id,fail_silently=False)
...
def send_email1(request):
    email= Student.get.objects_all() 
    user=email['email']
    time=SubmitAssignment.get.objects_all() 
    time=time['deadline']
    ...
    #EMAIL
    message = 'Reminder to submit assignment'
